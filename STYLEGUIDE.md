...
The backend is **not in this repo**. It is maintained at [github.com/krishagarwal278/supabase](https://github.com/krishagarwal278/supabase). This repo is **frontend-only**.
