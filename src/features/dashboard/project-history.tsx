...
import { Box, Typography, Skeleton, Card, Stack, Chip, IconButton } from "@mui/material";
import { formatDistanceToNow } from "date-fns";

import { useProjects, useDeleteProject, type Project } from "@/common/hooks/useProjects";
